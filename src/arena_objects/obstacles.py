...
class Obstacle(ArenaObject):
	def __init__(self, object_id, init_pos, initial_velocity, object_acceleration, dimensions, arena_height):
		super(Obstacle, self).__init__(object_id, init_pos, initial_velocity, object_acceleration, dimensions, arena_height)
...
class Cactus(Obstacle):
	def __init__(self, initial_position, initial_velocity=(-3, 0), object_acceleration=(0.0, 0.0),
		...
		super(Cactus, self).__init__(1, initial_position, initial_velocity, object_acceleration, cactus_dimension, arena_height)
...
class Bird(Obstacle):
	def __init__(self, base_position, initial_velocity=(-3, 0), object_acceleration=(0.0, 0.0),
		...
		super(Bird, self).__init__(2, initial_position, initial_velocity, object_acceleration, bird_dimension, arena_height)
